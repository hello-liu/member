    ...
    <div>
        <el-form ref="form" :model="form" label-width="100px">
            ...
            <el-form-item label="充值金额">
                <el-input ref="id_money" v-model.number="form.money" @keyup.enter.native="onSubmit"></el-input>
            </el-form-item>
    ...
    export default {
        ...
        methods: {
            onSubmit() {
                ...
                this.$http.post('busi.charge', this.form, this).then(respose => {
