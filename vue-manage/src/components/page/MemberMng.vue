    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="data" border stripe class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="money" label="余额" :formatter="formatterMoney" >
                </el-table-column>
        ...
        <!-- 编辑弹出框 -->
        <el-dialog title="编辑会员" :visible.sync="editVisible" width="50%">
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                this.$http.post('member.list', params, this).then(respose => {
            ...
            changeFlag(row){
                ...
                this.$http.post('member.updateFlag', params, this).then(respose => {
                    let data = respose.data
                    if("ok" == data.code){
                        //添加成功
                        this.getData();
